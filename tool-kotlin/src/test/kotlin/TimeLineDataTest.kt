...
internal class TimeLineDataTest {
    ...
    @Test
    fun getData() {
        val dataList: List<TimeLineData.Pojo> = listOf(
        ...
        val result = TimeLineData.Builder<Pojo>()
            .dataList(dataList)
            .k { getStr(LocalDateTime.ofInstant(it.date.toInstant(ZoneOffset.of("+8")), ZoneId.systemDefault()), DateType.MONTH) }
            .v { BigDecimal.valueOf(it.value.toDouble()) }
            .start(LocalDateTime.of(2020, 8, 1, 1, 1))
            .end(LocalDateTime.of(2021, 8, 1, 1, 1))
            .build()
            .data
        Assertions.assertEquals("{2020-08=0, 2020-09=0, 2020-10=0, 2020-11=0, 2020-12=0, 2021-01=0, 2021-02=0, 2021-03=0, 2021-04=0, 2021-05=0, 2021-06=0, 2021-07=0, 2021-08=9.0}",
            result.toString())
    }
}
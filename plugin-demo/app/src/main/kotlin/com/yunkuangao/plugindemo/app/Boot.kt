...
import com.yunkuangao.CompoundPluginDescriptorFinder
import com.yunkuangao.DefaultPluginManager
import com.yunkuangao.ManifestPluginDescriptorFinder
...
object Boot {
    ...
    private class PluginManager(importPaths: MutableList<Path>) : DefaultPluginManager(importPaths) {
    ...
    fun runDemo() {
        ...
        val pluginsDir = System.getProperty("pf.pluginsDir", "./plugins")
        logger.info("Plugin directory: $pluginsDir")
        // create the plugin manager
        val pluginManager = PluginManager(mutableListOf(Paths.get(pluginsDir)))
